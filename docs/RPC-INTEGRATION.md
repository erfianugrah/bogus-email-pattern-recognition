...
**Location**: [`forminator/src/lib/email-fraud-detection.ts:34-61`](https://github.com/erfianugrah/forminator/blob/main/src/lib/email-fraud-detection.ts#L34-L61)
...
**Location**: [`forminator/src/lib/email-fraud-detection.ts:64-69`](https://github.com/erfianugrah/forminator/blob/main/src/lib/email-fraud-detection.ts#L64-L69)
...
**Location**: `src/index.ts:368-416` (this repo)
...
**Location**: `src/middleware/fraud-detection.ts:861-928` (this repo)
...
**Migration**: `migrations/0007_add_enhanced_request_metadata.sql` (this repo)
...
In the forminator repository:
```bash
grep -A5 "services" wrangler.jsonc
```

See [forminator documentation](https://github.com/erfianugrah/forminator) for configuration details.
...
In this repository, check recent validations:
```bash
...
- [README.md](../README.md) - Complete markov-mail documentation
- [SCHEMA-INITIALIZATION.md](./SCHEMA-INITIALIZATION.md) - Database setup guide
- [API.md](./API.md) - API reference
- [ARCHITECTURE.md](./ARCHITECTURE.md) - System architecture

**External Repository (Forminator):**
- [Forminator Repository](https://github.com/erfianugrah/forminator) - Form submission platform
- [Forminator Documentation](https://github.com/erfianugrah/forminator/blob/main/CLAUDE.md)
- [Forminator RPC Integration](https://github.com/erfianugrah/forminator/blob/main/docs/RPC-INTEGRATION.md)

 ...
 * Example: john@example.com,192.168.1.1,legitimate,professional
 */
...
OPTIONS
  ...
  --endpoint <url>      API endpoint to test (default: https://fraud.erfi.dev/validate)
